// =========================================================
// オフライン時の画面上部バナー (主催者画面共通)
// register.html の B-3 として最初に register に入ったロジックを 4 画面で共有化したもの。
...
(function () {
  function ensureBanner() {
    ...
    if (!banner) {
      ...
      banner.textContent = '⚠ オフラインです。保存・同期は接続復帰後に行ってください。';
